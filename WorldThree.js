...
{levelText:"OPPOSITE",
floor:[{left:{x:150,y:375},right:{x:300,y:75},type:floor},
	{left:{x:300,y:75},right:{x:365,y:205},type:floor},
	{left:{x:365,y:205,states:[{x:365,y:205},{x:0,y:0}]},
		right:{x:388,y:251,states:[{x:388,y:251},{x:0,y:0}]},
		type:button,trig:2,state:0},
	{left:{x:387.5,y:250},right:{x:450,y:375},type:floor},
	{left:{x:150,y:375},right:{x:450,y:375},type:floor},
	{left:{x:250,y:175,states:[{x:250,y:175},{x:260,y:215}]},
	right:{x:300,y:175,states:[{x:300,y:175},{x:300,y:175}]},
	type:button, trig:1, state:0},
	{left:{x:300,y:175},right:{x:350,y:175},type:floor},
	{left:{x:225,y:225},right:{x:275,y:250},type:floor},
	{left:{x:275,y:250},right:{x:325,y:250},type:bridge},
	{left:{x:325,y:250},right:{x:415,y:250},type:floor},
	{left:{x:175,y:325},right:{x:215,y:325},type:floor},
	{left:{x:215,y:325},right:{x:240,y:325},type:bridge},
	{left:{x:240,y:325},right:{x:270,y:325},type:floor}
	],
wall:[{top:350,bottom:375,x:300}],
buttons:[{x:275,y:175,trigger:1,color:"magenta"},
	{x:360,y:250,trigger:2,color:"pink"}],
portals:[{color:"#b666d2",a:{x:400,y:250,theta:0,loc:1},b:{x:190,y:325,theta:0,loc:1}},
	{color:"#bfb4fe",a:{x:250,y:375,theta:0,loc:1},b:{x:325,y:375,theta:0,loc:1}},
	{color:"#bfb4fe",a:{x:275,y:375,theta:0,loc:1},b:{x:465,y:375,theta:0,loc:1}}],
